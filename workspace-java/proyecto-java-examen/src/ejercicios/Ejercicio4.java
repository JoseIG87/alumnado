...
public class Ejercicio4 {
	...
	private static void informacion(List<Integer> lista1, Integer numero) {
		...
		//En tercer lugar muestra la posicion en la lista de enteros del numero que es igual a "tamaño de lista dividio 2", 
		...
		//al segundo numero pasado como parametro, luego consulta si ese contador es mayor a "tamaño de lista dividido 2" 
